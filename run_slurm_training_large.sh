...
LD_LIBRARY_PATH="/usr/lib/nvidia:$MUJOCO_PY_MUJOCO_PATH:$CONDA_PREFIX/lib:$LD_LIBRARY_PATH" torchrun --nnode=1 --nproc_per_node=8 train.py --config-dir=. --config-name=uva_rlbench_large.yaml \
    ...
    logging.project=uva_large \
    hydra.run.dir="checkpoints/uva_rlbench_large_video_model" \
