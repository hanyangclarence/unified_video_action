...
#         model.policy.autoregressive_model_params.pretrained_model_path=pretrained_models/libero10.ckpt \
#         model.policy.selected_training_mode=video_model \
#         model.policy.optimizer.learning_rate=1e-4 \
#         logging.project=uva_pn \
#         hydra.run.dir="checkpoints/uva_rlbench_pn_video_model_new"
...
accelerate launch --num_processes=8 train.py \
        ...
        model.policy.autoregressive_model_params.pretrained_model_path="checkpoints/uva_rlbench_pn_video_model_new/checkpoints/latest.ckpt" \
        model.policy.optimizer.learning_rate=1e-4 \
        logging.project=uva_pn \
        hydra.run.dir="checkpoints/uva_rlbench_pn_video_act_model_new" \
